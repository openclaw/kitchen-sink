...
export function registerAllRegistrars(api) {
  ...
  safeRegister("registerBoardWidgetContentKind", () => api.registerBoardWidgetContentKind(payloadFor("registerBoardWidgetContentKind")));
  ...
  safeRegister("registerMemoryPromptPreparation", () => api.registerMemoryPromptPreparation(payloadFor("registerMemoryPromptPreparation")));
  ...
  safeRegister("registerSessionCatalog", () => api.registerSessionCatalog(payloadFor("registerSessionCatalog")));
  ...
  safeRegister("registerTranscriptSourceProvider", () => api.registerTranscriptSourceProvider(transcriptSourceProviderPayload()));
  ...
  safeRegister("registerWidgetPresenter", () => api.registerWidgetPresenter(payloadFor("registerWidgetPresenter")));
  safeRegister("registerWorkerProvider", () => api.registerWorkerProvider(payloadFor("registerWorkerProvider")));
